...
% wind speeds since Cp = Pturbine/Pwind. e.g. When the when wind speed is 
% low, and Pwind is low but Pturbine might already be high and the rotating
% turnbine cannot slow down immediately.
